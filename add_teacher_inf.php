	...
	<body>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" id="genePanel">
				...
				<p><span class="text-label"><strong>教工号：</strong></span><input type="number" id="idText" class="basic-input" autocomplete="off"></p>
				...
				<p>
					<div><span class="text-label"><strong>职称：</strong></span>
						<div class="btn-group">
							<button type="button" id="titleText" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">助教<span class="caret"></span></button>
				...
				<p><span class="text-label"><strong>薪水：</strong></span><input type="number" id="salaryText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>已评价：</strong></span><input type="number" id="evaluateNumText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>教评得分：</strong></span><input type="number" id="scoreText" class="basic-input" autocomplete="off"></p>
