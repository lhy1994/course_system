	...
	<body>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<p><span class="text-label"><strong>课程名：</strong></span><input type="text" id="nameText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>id：</strong></span><input type="number" id="idText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>任课教师id：</strong></span><input type="number" id="teacherIdText" class="basic-input" autocomplete="off"></p>
				<p>
					<div><span class="text-label"><strong>类型：</strong></span>
						<div class="btn-group">
							<button type="button" id="courseTypeText" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">必修课<span class="caret"></span></button>
				...
				<p><span class="text-label"><strong>学分：</strong></span><input type="number" id="creditText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>课时数：</strong></span><input type="number" id="hourText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>开始周：</strong></span><input type="number" id="startWeekText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>结束周：</strong></span><input type="number" id="endWeekText" class="basic-input" autocomplete="off"></p>
				<p><span class="text-label"><strong>价格：</strong></span><input type="number" id="priceText" class="basic-input" autocomplete="off"></p>
			</div>
		</div>
