	...
	<body>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" id="genePanel">
				<p><span class="text-label"><strong>姓名：</strong></span><input type="text" id="nameText" class="basic-input" autocomplete="off" value="<?php echo $admin->name; ?>"></p>
				<p><span class="text-label"><strong>编号：</strong></span><?php echo $admin->id; ?><span class="label label-info">不可更改</span></p>
				<p><span class="text-label"><strong>性别：</strong></span><input type="checkbox" id="genderText" val="<?php echo $admin->gender; ?>" <?php if($admin->gender == 0) echo 'checked'; ?> data-toggle="toggle" data-size="small" data-on="女" data-off="男"></p>
				<p><span class="text-label"><strong>生日：</strong></span><input type="date" id="birthdayText" class="basic-input" autocomplete="off" value="<?php echo $admin->birthday; ?>"></p>
			</div>
		</div>
		<div class="panel panel-primary">
			<div class="panel-heading">
