	...
	<body>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" id="genePanel">
				...
				<p><span class="text-label"><strong>学号：</strong></span><input type="number" id="idText" class="basic-input" autocomplete="off"></p>
				...
				<p><span class="text-label"><strong>已获得学分：</strong></span><input type="number" id="creditText" class="basic-input" autocomplete="off"></p>
			</div>
		</div>
		<div class="panel panel-primary">
			<div class="panel-heading">
