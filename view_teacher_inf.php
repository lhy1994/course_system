...
<html lang="en">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$(document.body).on('click', '.edit', function() {
					$('#teacherID').val($(this).parent().prevAll('th').text());
					$('#editReq').submit();
				});
				...
				$(document.body).on('click', '.delete', function() {
					...
					$this = $(this);
					$.post('delete_teacher_inf.php', parameter, function() {
	...
	<body>
		...
		<form id="editReq" method="post" action="edit_teacher_inf.php">
			<input id="teacherID" type="hidden" name="teacher_id" value="">
		</form>
